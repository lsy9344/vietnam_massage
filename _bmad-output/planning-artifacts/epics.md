...
FR3: Epic 4 - 주인용 화면에서 매출, 콜, 객실, 노쇼/취소, 정산 순위를 시각화한다.
...
FR20: Epic 5 - 마사지사 일별 출퇴근 입력, 자정 넘김 계산, 만근 인정 기초를 제공한다.

FR21: Epic 5 - 마사지사1/2 배정 콜을 모두 인정하는 마사지사 일일정산을 제공한다.

FR22: Epic 5 - 귀케어사 일별 근무상태 입력과 지급 대상 판정을 제공한다.

FR23: Epic 5 - 귀케어 풀 균등 분배와 정상근무자 0명 지급액 0원 처리를 제공한다.

FR24: Epic 5 - 운영팀 근무상태와 일 총콜 기준 일일 인센 계산을 제공한다.

FR25: Epic 5 - 운영월 총콜 기준 운영팀 월 인센 미리보기를 제공한다.

FR26: Epic 6 - 운영월 마사지사, 운영팀, 귀케어 지급액 월마감 미리보기를 제공한다.

FR27: Epic 6 - 만근 인정일 20일 이상 만근수당 계산을 제공한다.

FR28: Epic 6 - 월 총콜 40콜 이상 갯수왕 1~3위 수당 계산과 근거 표시를 제공한다.

FR29: Epic 6 - 월마감 미리보기, 검토, 확정, 잠금과 마감 스냅샷을 제공한다.

FR30: Epic 6 - 관리자 사유 기반 월마감 재오픈과 감사 로그를 제공한다.

FR31: Epic 4 - 조회날짜 기준 오늘 KPI 대시보드를 제공한다.

FR32: Epic 4 - 운영월 기준 월간 KPI와 확정 스냅샷 기준 조회를 제공한다.

FR33: Epic 4 - 원본 엑셀에서 산출 가능한 주인용 그래프 리포트를 제공한다.
...
### Story 5.1: 마사지사 출퇴근 입력과 만근 인정 기초
...
**And** 변경 이력은 Story 5.3 감사 로그로 추적된다.
...
**And** 만근 인정일은 Story 5.1의 일별 대기시간 8시간 이상 인정 결과를 기준으로 한다.
...
### Story 6.4: 잠금 상태와 지급 영향 데이터 수정 차단
...
**Then** Story 6.3의 월마감 확정 domain service가 호출된다
