export const MIGRATION_SOURCE_REFERENCES = {
  realtimeLedger:
    "sheet_erp_design.md §7.2 실시간콜입력 + 2026-06-15 수정요청: 예약건수는 원장 전체, 결제수단 선택/사용중 선결제는 매출 반영, 마사지사수당/귀케어풀/콜인정은 방문완료 정산 기준. Evidence range: A:S, U:X.",
  roomStatus:
...
export const MIGRATION_EXPECTED_RESULTS = {
  callCalculation: {
    ...
    dailySummary: { reservationCount: 10, inUseCount: 1, cleaningCount: 1, completedCount: 5, noShowCount: 1, canceledCount: 1, paymentTotal: 9400000, discountTotal: 100000, earcarePoolTotal: 400000, therapistCommissionTotal: 3400000, expenseTotal: 50000, netSales: 9350000 }
  },
  roomStatus: [
